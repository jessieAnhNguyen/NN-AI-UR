...
public class MajorityPerceptronNN extends SingleLayerFeedForwardNeuralNetwork {
	...
	public static void main(String[] argv) {
		...
		NeuralNetworkDisplay display = new NeuralNetworkDisplay("Majority Perceptron");
		...
		String newName = "majority-perceptron-output.csv";
		display.writeDataFilePerceptron(newName, nmax, nstep);
