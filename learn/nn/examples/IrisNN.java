...
import learn.nn.display.NeuralNetworkDisplay;
...
public class IrisNN extends MultiLayerFeedForwardNeuralNetwork {
	...
	public static void main(String[] argv) throws IOException {
		...
		NeuralNetworkDisplay display = new NeuralNetworkDisplay("Iris Neural Network");

		for (int epoch=100; epoch <= epochs; epoch +=100) {
			network.train(examples, epoch, alpha);
		...
		String newName = "iris-output.csv";
		display.writeDataFileNN(newName, epochs);
	}
